...
public class IntakeSubsystem extends Intake {
    ...
    public void setupConfigs_INTAKE() {
        ...
        configs_intake.Slot0.kP = 0.33; // An error of 1 rotation per second results in 0.11 V output
        configs_intake.Slot0.kI = 0; // No output for integrated error
        configs_intake.Slot0.kD = 0.1; // No output for error derivative
